  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 px-4 py-4 border-b">
        ...
        {!collapsed && (
          <span className="font-bold text-lg">Gia phả họ Bùi</span>
        )}
      </div>
      ...
      {!collapsed && (
        <div className="border-t px-4 py-3">
          <p className="text-xs text-muted-foreground leading-relaxed">
            Quản trị viên:{" "}
            <span className="font-semibold text-foreground">Bùi Hữu Công</span>,
            vui lòng liên hệ
            <br />
            <span className="font-semibold text-foreground">📞 0975707208</span>
            <br />
            <span className="text-[10px] opacity-70">congkti@gmail.com.</span>
          </p>
        </div>
      )}
